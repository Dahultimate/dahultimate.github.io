...
type Tab = "home" | "members" | "age-categories" | "event-references" | "events" | "physical-prep" | "calendar";
...
const TABS: readonly TabDef[] = [
  ...
  { id: "calendar", label: "Calendrier", icon: "🗓️", visible: () => true },
